...
const Dashboard = props => {
  ...
  return (
    <div>
      ...
      <Route path='/events/upcoming' render={ () => <EventsList events={upcomingEvents} relationships={props.relationships} setEvents={props.setEvents} path={'/events/upcoming'} viewEvent={props.viewEvent} /> } />
      <Route path='/events/past' render={ () => <EventsList events={pastEvents} path={'/events/past'} viewEvent={props.viewEvent} /> } />
    </div>
  )
